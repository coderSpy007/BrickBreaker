...
public class GameOverNormal extends AppCompatActivity {
    TextView hPoint;
    ImageView hightest;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.game_over_normal);
    ...
    public void restart(View view) {
        Intent intent = new Intent(GameOverNormal.this, SelectLevel.class);
